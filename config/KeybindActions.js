...
var ACTION_CATALOG = [
    ...
    { id: "audio.volume-up", label: "Volume Up", category: "Audio", dispatcher: "exec", argument: "wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+", flags: "le" },
    { id: "audio.volume-down", label: "Volume Down", category: "Audio", dispatcher: "exec", argument: "wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%-", flags: "le" },
...
function actionFromLegacy(dispatcher, argument, flags) {
    ...
    if (dispatcher === "exec") {
        ...
        if (arg.indexOf("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+") === 0) return { id: "audio.volume-up", args: {} };
        if (arg.indexOf("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%-") === 0) return { id: "audio.volume-down", args: {} };
